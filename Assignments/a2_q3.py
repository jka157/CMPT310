...
def run_q3():
    ...
    for one in range(0, 31):
        # if stop == False:

        # Create teams
        team_colors = create_Teams(one+1, 31)

        # Colors = Domain, Neighbors = graph[0-6]
        ice_breaker = MapColoringCSP(team_colors, graphs[0])
        AC3(ice_breaker)

        csp_sol = (backtracking_search(ice_breaker, select_unassigned_variable=mrv, inference=forward_checking))
        ...
        if csp_sol != None:
            ...
            print("For friendship graph for n = 31, p = 0.1: ")
    ...
    for two in range(0, 31):
        # if stop == False:

        # Create teams
        team_colors = create_Teams(two+1, 31)
        ...
        if csp_sol != None:
            ...
            team, team_number, members = max_member(csp_sol)
            print("For friendship graph for n = 31, p = 0.2: ")
            print("The number of teams that the people are divided into:", team)
            print(f'The running time of the solver (in seconds): {elapsed_time}s')
            print("The count of the number of CSP variables assigned:", ice_breaker.nassigns)
            print("The count of the number of CSP variables unassigned:", ice_breaker.unassigns_count())
    ...
    for three in range(0, 31):
        # if stop == False:

        # Create teams
        team_colors = create_Teams(three+1, 31)
        ...
        if csp_sol != None:
            ...
            team, team_number, members = max_member(csp_sol)
            print("For friendship graph for n = 31, p = 0.3: ")
            print("The number of teams that the people are divided into:", team)
            print(f'The running time of the solver (in seconds): {elapsed_time}s')
            print("The count of the number of CSP variables assigned:", ice_breaker.nassigns)
            print("The count of the number of CSP variables unassigned:", ice_breaker.unassigns_count())
    ...
    for four in range(0, 31):
        # if stop == False:

        # Create teams
        team_colors = create_Teams(four+1, 31)
        ...
        if csp_sol != None:
            ...
            team, team_number, members = max_member(csp_sol)
            print("For friendship graph for n = 31, p = 0.4: ")
            print("The number of teams that the people are divided into:", team)
            print(f'The running time of the solver (in seconds): {elapsed_time}s')
            print("The count of the number of CSP variables assigned:", ice_breaker.nassigns)
            print("The count of the number of CSP variables unassigned:", ice_breaker.unassigns_count())
    ...
    for five in range(0, 31):
        # if stop == False:

        # Create teams
        team_colors = create_Teams(five+1, 31)
        ...
        if csp_sol != None:
            ...
            team, team_number, members = max_member(csp_sol)
            print("For friendship graph for n = 31, p = 0.5: ")
            print("The number of teams that the people are divided into:", team)
            print(f'The running time of the solver (in seconds): {elapsed_time}s')
            print("The count of the number of CSP variables assigned:", ice_breaker.nassigns)
            print("The count of the number of CSP variables unassigned:", ice_breaker.unassigns_count())
    ...
    for six in range(0, 31):
        # if stop == False:

        # Create teams
        team_colors = create_Teams(six+1, 31)
        ...
        if csp_sol != None:
            ...
            team, team_number, members = max_member(csp_sol)
            print("For friendship graph for n = 31, p = 0.6: ")
            print("The number of teams that the people are divided into:", team)
            print(f'The running time of the solver (in seconds): {elapsed_time}s')
            print("The count of the number of CSP variables assigned:", ice_breaker.nassigns)
            print("The count of the number of CSP variables unassigned:", ice_breaker.unassigns_count())
